...
begin
 if p_stale_seconds < 60 or p_stale_seconds > 86400 then raise exception 'invalid_stale_window'; end if;
 ...
 if d.created_at < now()-interval '23 hours' then raise exception 'idempotency_window_expired'; end if;
