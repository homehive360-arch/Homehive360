...
begin
 ...
 for l in select id,marketing_email_allowed,marketing_sms_allowed from public.leads where hive_id=c.hive_id and (r.last_lead_id is null or id>r.last_lead_id) order by id limit greatest(1,least(p_limit,1000))
 loop
