alter table public.promotion_deliveries drop constraint promotion_deliveries_provider_state_check;
alter table public.promotion_deliveries add constraint promotion_deliveries_provider_state_check check (
 ...
 or (status='failed' and sending_at is not null and sent_at is null and delivered_at is null)
);