...
export default function BrunswickDemoHive(){
 ...
 function clearSeat(category:string){setSeats(s=>({...s,[category]:''}));}
 function restoreSeat(category:string){const found=selected.find(x=>x[0]===category);if(found)setSeats(s=>({...s,[category]:found[1]}));}
 return <Shell>
